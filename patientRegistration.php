...
<form action="registerPat.php" method="POST" class="form">
    <div class="input-box">
      <label>Patient NRIC</label>
      <input type="text" name="patientNRIC" placeholder="Enter NRIC" required />
    </div>
    ...
    <div class="input-box">
      <button type="submit" onclick="return showMessage()">Submit</button>
    </div>
</form>
</section>
...
<script>
  function showMessage() {
    ...
    if (patientID) {
      alert('YOUR PATIENT ID: ' + patientID + '. PLEASE USE THIS PATIENT ID TO LOG INTO THE SYSTEM.');
