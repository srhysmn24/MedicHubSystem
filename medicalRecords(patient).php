...
try {
    $sql = "SELECT 
        ...
        JOIN medicalcertificate mc ON a.appointmentID = mc.appointmentID
            ...
            <table class="transparent-table">
				...
				if ($result && count($result) > 0) {
					foreach ($result as $row) {
						...
						echo "<td><button class='edit-btn' onclick='downloadAsPDF(". $row["appointmentID"]. ")'>Download</button></td>";
						echo "</tr>";
					}
				} else {
